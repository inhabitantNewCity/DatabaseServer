// класс служит кешом для базы, если карта уже загружалась на сервер, то она будет взята из локальной памяти.
// предложенное решение было реализовано врамках оптимизации работа сервера
#pragma once
#include "Map.h"
#include "Stubs.h"
